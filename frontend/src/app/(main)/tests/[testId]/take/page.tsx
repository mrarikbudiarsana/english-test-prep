  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="relative w-32 h-1.5 bg-slate-100 rounded-full cursor-pointer">
        ...
        />
        <div ref={trackRef} className="absolute left-0 top-0 h-full bg-blue-600 rounded-full" style={{ width: `${volume * 100}%` }} />
        <div ref={thumbRef} className="absolute top-1/2 -translate-y-1/2 h-3.5 w-3.5 bg-white border-2 border-blue-600 rounded-full shadow-md z-0" style={{ left: `calc(${volume * 100}% - 7px)` }} />
      </div>
        ...
        <footer className="shrink-0 border-t border-slate-200 bg-white px-6 py-2.5 z-40">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-1.5 bg-blue-600 text-white text-xs font-semibold rounded hover:bg-blue-700 transition-colors active:scale-95 group"
            >
