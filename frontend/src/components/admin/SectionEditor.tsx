...
export default function SectionEditor({ testId, existingSections = [], initialData, onSubmit, onCancel }: SectionEditorProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await onSubmit({
        ...
        partNumber: sectionType === 'speaking' ? partNumber : null,
